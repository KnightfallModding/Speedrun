...
public class Timer : MonoBehaviour
{
    ...
    public void StopTimer() => hasStarted = false;
    public float GetTime() => this.timer;
    public string GetFormattedTime() => GetFormattedTime(this.timer);

    /// <summary>
    /// Format float timer to "00:00.00"
    /// </summary>
